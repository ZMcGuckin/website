...
function Circle() {
	this.settings = {ttl:8000, xmax:5, ymax:2, rmax:5, rt:1, xdef:960, ydef:540, xdrift:4, ydrift: 4, random:true, blink:true};
	this.reset = function() {
...
this.draw = function() {
	...
	gradient.addColorStop(0.0, 'rgba(244,203,66,'+newo+')');
